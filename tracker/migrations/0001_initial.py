...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'mode',
                    models.CharField(
                        choices=[('point', 'Point'), ('state', 'State')],
                        default='point',
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'event_kind',
                    models.CharField(
                        choices=[('point', 'Point'), ('start', 'Start'), ('stop', 'Stop')],
                        max_length=10,
                    ),
                ),
                ...
                (
                    'modifiers',
                    models.ManyToManyField(
                        blank=True, related_name='events', to='tracker.modifier'
                    ),
                ),
                (
                    'session',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=('session', 'video'), name='unique_video_per_session'
            ),
        ),
    ]
