...
urlpatterns = [
    ...
    path(
        'projects/<int:pk>/export/bundle/',
        views.project_export_bundle,
        name='project_export_bundle',
    ),
    path(
        'projects/<int:pk>/export/boris-json/',
        views.project_export_boris_json,
    ...
    path(
        'projects/<int:pk>/memberships/new/',
        views.project_membership_create,
    ...
    path(
        ...
        views.project_membership_delete,
        name='project_membership_delete',
    ),
    path(
        'projects/<int:pk>/keyboard-profiles/new/',
        views.keyboard_profile_create,
        name='keyboard_profile_create',
    ),
    path(
        'keyboard-profiles/<int:pk>/edit/',
        views.keyboard_profile_update,
        name='keyboard_profile_update',
    ),
    path(
        'keyboard-profiles/<int:pk>/delete/',
        views.keyboard_profile_delete,
        name='keyboard_profile_delete',
    ),
    ...
    path(
        'sessions/<int:pk>/media-analysis/',
        views.session_media_analysis_json,
        name='session_media_analysis_json',
    ),
    ...
    path(
        'sessions/<int:pk>/export/compatibility-report/',
        views.session_export_compatibility_report,
        name='session_export_compatibility_report',
    ),
    path(
        'sessions/<int:pk>/export/cowlog-txt/',
        views.session_export_cowlog_txt,
        name='session_export_cowlog_txt',
    ),
    ...
    path(
        'sessions/<int:pk>/export/behavioral-sequences/',
        views.session_export_behavioral_sequences,
        name='session_export_behavioral_sequences',
    ),
    path(
        'sessions/<int:pk>/export/textgrid/',
        views.session_export_textgrid,
        name='session_export_textgrid',
    ),
    path(
        'sessions/<int:pk>/export/binary-table/',
