...
urlpatterns = [
    ...
    path('sessions/<int:pk>/annotations/add/', views.annotation_create_api, name='annotation_create_api'),
    ...
    path('sessions/<int:pk>/export/boris-json/', views.session_export_boris_json, name='session_export_boris_json'),
