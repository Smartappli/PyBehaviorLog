...
class ViewTests(TestCase):
    ...
    def test_event_api_create_list_and_export_json(self):
        ...
        self.assertIn('pybehaviorlog-0.8.6-session', export_response.content.decode('utf-8'))
    ...
    def test_project_import_boris_json_view(self):
        payload = {
            ...
            'ethogram': {'schema': 'pybehaviorlog-0.8.6-ethogram', 'categories': [], 'modifiers': [], 'subject_groups': [], 'subjects': [], 'variables': [], 'behaviors': [{'name': 'Imported behavior', 'description': '', 'key_binding': 'i', 'color': '#0f766e', 'mode': 'point', 'sort_order': 1, 'category': None}]},
